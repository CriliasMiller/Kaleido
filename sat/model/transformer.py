...
class BaseTransformerLayer(torch.nn.Module):
    def __init__(
        ...
        # Self attention.
        # print_rank0("Creating self attention")
        ...
        # print_rank0("successfully created self attention")
        # Layernorm on the input data.
        ...
        # Cross attention.
        # print_rank0("Creating cross attention")
        if self.is_decoder:
            ...
            # for wanx video, post_cross_attn need elementwise_affine = True
            self.post_cross_attention_layernorm = LayerNorm(hidden_size, eps=layernorm_epsilon, elementwise_affine=True)
        # MLP
        self.mlp = MLP(
            hidden_size,
            output_dropout_prob,
...
class BaseTransformer(torch.nn.Module):
    ...
    def forward(self, input_ids, position_ids, attention_mask, *,
        ...
        #             print(f"{name}: weight type after forward: {type(module.weight)}")
        ...
        if self.checkpoint_activations:
            ...
            while l < num_layers:
                ...
                if l + self.checkpoint_skip_layers >= num_layers:
                    ...
                    check_fun = checkpoint if not kw_args['fsdp2'] else torch_checkpoint
                    hidden_states, output_per_layers_part, output_cross_layer, *flat_outputs = \
